...
const SchemeDetail = () => {
  ...
  const fetchSchemeDetails = async () => {
    ...
    try {
      ...
      const response = await fetch(`${url}/api/schemes/getScheme/${id}`, {
        headers: {
  ...
  const handleVerifyScheme = async () => {
    ...
    try {
      ...
      const response = await fetch(`${url}/api/schemes/verify/${id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleRejectScheme = async () => {
    ...
    try {
      ...
      const response = await fetch(`${url}/api/schemes/reject/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
