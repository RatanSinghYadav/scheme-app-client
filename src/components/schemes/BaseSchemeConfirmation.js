    ...
    return (
        ...
        >
            <div style={{ height: '100%', overflow: 'auto' }}>
                ...
                {/* selected groups table - only show when groups are selected */}
                {selectedGroups && selectedGroups.length > 0 && (
                    <Card title="Selected Groups" style={{ marginBottom: '16px' }}>
                        <Table
                            columns={[
                                { title: 'Sr.', dataIndex: 'sr', key: 'sr', width: 60, render: (_, __, index) => index + 1 },
                                { title: 'Distributor Group', dataIndex: 'group', key: 'group' }
                            ]}
                ...
                {/* selected products table - only show when products are selected */}
...
export default BaseSchemeConfirmation;